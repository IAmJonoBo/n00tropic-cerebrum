...
Add documentation to xref:n00t:reference/mcp-capabilities.adoc[]:
...
* xref:n00t:reference/mcp-capabilities.adoc[MCP Capabilities Reference]
* xref:n00t:adr/adr-003-capability-manifest-schema.adoc[ADR-003: Manifest Schema]
* xref:n00t:adr/adr-004-guardrails-framework.adoc[ADR-004: Guardrails]
