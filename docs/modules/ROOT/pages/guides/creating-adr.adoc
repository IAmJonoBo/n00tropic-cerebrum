...
* xref:n00t:adr/adr-001-mcp-server-architecture.adoc[ADR-001: MCP Server Architecture]
* xref:n00tropic:adr/adr-004-multi-model-strategy.adoc[ADR-004: Multi-Model Strategy]
...
* xref:n00t:adr/index.adoc[n00t ADR Index]
* xref:n00-frontiers:adr/README.adoc[n00-frontiers ADR Index]
