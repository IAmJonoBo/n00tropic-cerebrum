...
1. Promote **n00t** to the canonical agent orchestration surface:
...
2. Establish **n00-school** as the training and evaluation hub:
...
1. Flesh out n00t capability manifests (MCP resources) for meta-check, refresh, release, and simulated project runs.
2. Draft n00-school ADRs for dataset governance, evaluation metrics, and deployment of trained artefacts.
3. Wire n00t telemetry ingestion into Cortex catalogs and dashboards (design TBD).
4. Migrate existing automation scripts to call n00t APIs rather than shelling directly wherever feasible.
