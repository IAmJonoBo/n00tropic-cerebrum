...
1. **Explore Capabilities**: See xref:n00t:reference/mcp-capabilities.adoc[MCP Capabilities Reference]
...
4. **Understand Architecture**: See xref:n00t:adr/adr-001-mcp-server-architecture.adoc[ADR-001: MCP Server Architecture]
...
**Support**: For MCP-specific issues, see xref:n00t:troubleshooting.adoc[n00t Troubleshooting] or review xref:n00t:adr/adr-003-capability-manifest-schema.adoc[ADR-003: Capability Manifest Schema].
