...
├── n00-cortex/              # Schemas, manifests, catalogs (submodule)
├── n00-frontiers/           # Templates and standards (submodule)
├── n00t/                    # Agent control panel (submodule)
├── n00tropic/               # AI design generator (submodule)
├── n00-horizons/            # Project planning (submodule)
├── n00-school/              # Learning resources (submodule)
├── n00clear-fusion/         # Integration framework (submodule)
├── n00menon/                # Documentation site (submodule)
├── .dev/automation/         # Workspace-level automation
├── docs/                    # Cerebrum documentation
└── mcp/                     # MCP servers
----
...
4. **Explore Capabilities**: See xref:n00t:reference/mcp-capabilities.adoc[MCP Capabilities Reference]
