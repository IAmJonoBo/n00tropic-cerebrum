...
* Pre-push: tidy submodules, manifest gate, doc auto-format (`docs:fix-style`), and run `docs:lint` in CI.
* Docs quality: `docs:lint` = Vale + Lychee + attribute checks + AsciiDoc parse. Auto-format headings and style via `docs:fix-style`.
